...
@WebServlet("/AdminPassSellerServlet")
public class AdminPassSellerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //System.out.println("该商家通过审核");
        String shop_id = request.getParameter("shop_id");
        List<Seller> sellerList=sellerServer.passSeller(shop_id);
