...
@WebServlet("/SellerIsQuitServlet")
public class SellerIsQuitServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //System.out.println("商家请求退出");
        Seller sellerList=sellerServer.sellerIsQuit(id);
